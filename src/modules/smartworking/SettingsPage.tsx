...
import { loadSettings, saveSettings, isConfigured } from '../shared/settings.ts'
      ...
      <div className="settings-card glass-card">
        ...
        <div className="settings-form">
          ...
          <div className="settings-field">
            ...
            />
            <span className="settings-hint">Generato automaticamente, usato per identificarti</span>
          </div>
